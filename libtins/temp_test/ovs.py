# OpenVSwitch module
# SAVI McGill: Heming Wen, Prabhat Tiwary, Kevin Han, Michael Smith, Hoai Phuoc Truong
#
...
# This is the modified version of original ovs module in auroraagent to exclude the database dependencies
# so that ovs module can be used by datapath_manager
...
class OpenVSwitch:
    ...
    def start(self):
        ...
        print "Enabling socket file with temporary file: %s" % self.socket_file.name
    ...
    def modify_port(self, bridge, port, command, parameters=None):
        ...
        print "No port modifications to OVS allowed."
